...
export default function ExperiencesClientPage() {
  const { data, isLoading, isError } = useGetExperiences({ limit: 100 });
  ...
  return (
    <>
      <AdminPageHeader eyebrow="Career" title="Experiences" count={experiences.length} action={<Button href="/admin/experiences/create" variant="primary" externalIcon={false}>Create Experience</Button>} />
