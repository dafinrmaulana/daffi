...
export default function ProjectsClientPage() {
  const { data, isLoading, isError } = useGetProjects({ limit: 100 });
  ...
  return (
    <>
      <AdminPageHeader eyebrow="Portfolio" title="Projects" count={projects.length} action={<Button href="/admin/projects/create" variant="primary" externalIcon={false}>Create Project</Button>} />
